...
//   private static final Matrix<N3, N1> SINGLE_TAG_TELEOP_STD_DEVS = VecBuilder.fill(0.1, 0.1,
// 4.0);
...
//   /**
//    * OPTIMIZED: Fast standard deviation calculation. Pre-computed values and minimal branching
// for
//    * speed.
//    */
...
//   /**
//    * Log vision data to SmartDashboard (called once per periodic cycle to avoid duplicate
// logging)
//    */
//   public void log() {
